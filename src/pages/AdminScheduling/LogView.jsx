...
const STATUS_CONFIG = {
    "Waiting for Admin Approval":   { color: "bg-amber-100 text-amber-700",    label: "Waiting for Admin Approval" },
    "Pending Student Interest":     { color: "bg-cyan-100 text-cyan-700",      label: "Pending Student Interest" },
    "Teacher Assigned":             { color: "bg-purple-100 text-purple-700",  label: "Teacher Assigned" },
    "Waiting for Teacher Approval": { color: "bg-orange-100 text-orange-700",  label: "Waiting for Teacher Approval" },
...
export default function AdminRequestLogView() {
    ...
    const goBack = () => navigate("/admin-scheduling/log");

    useEffect(() => {
        if (!location.state?.item) {
            setError("Log entry not found. Please go back and select a record.");
        }
    }, [location.state]);
    ...
    const handlePrintPDF = () => {
        ...
        generatePersonalInfoPDF({
            title: "Admin Request Log Details",
            data: {
                ...item,
    ...
    return (
        <AppLayout title="View Log Entry" onPrint={item ? handlePrintPDF : undefined}>
            <div className="space-y-6">
                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold text-gray-900">Log Entry Details</h1>
                    ...
                    !error && (
                        <Alert>
                            <AlertCircle className="h-4 w-4" />
                            <AlertDescription>Log entry not found.</AlertDescription>
                        </Alert>
                    )
                )}
            </div>
