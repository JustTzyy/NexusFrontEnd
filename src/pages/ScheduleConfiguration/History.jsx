...
const STATUS_CONFIG = {
    "Pending Teacher Interest": { color: "bg-indigo-50 text-indigo-700 ring-1 ring-indigo-200", label: "Pending Teacher Interest" },
    "Teacher Assigned":         { color: "bg-purple-50 text-purple-700 ring-1 ring-purple-200", label: "Teacher Assigned" },
    "Waiting for Teacher Approval": { color: "bg-amber-50 text-amber-700 ring-1 ring-amber-200", label: "Waiting for Teacher Approval" },
    "Waiting for Admin Approval":   { color: "bg-orange-50 text-orange-700 ring-1 ring-orange-200", label: "Waiting for Admin Approval" },
