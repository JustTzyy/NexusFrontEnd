...
export default function StudentRequestTracking() {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            console.error(err);
            setError("Failed to load request tracking data");
        } finally {
            setLoading(false);
        }
    }, []);
    ...
    const handlePrintPDF = () => {
        generatePDF({
            title: "Student Request Tracking Report",
            data: filtered,
            columns: [
    ...
    return (
        <AppLayout title="Student Request Tracking" onPrint={filtered.length > 0 ? handlePrintPDF : undefined}>
            {loading ? (
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Student Request Tracking</h1>
                            <p className="mt-1 text-sm text-gray-600">
                                History of confirmed and cancelled student-submitted requests
                            </p>
                        </div>
                        ...
                        <div className="border rounded-lg py-20 text-center bg-white">
                            ...
                            <p className="font-medium text-gray-600">
                                {q || fromDate || toDate || statusFilter !== "all"
                                    ...
                                    : "No completed or cancelled student requests found"}
                            </p>
                            <p className="text-sm text-gray-400 mt-1">
                                {q || fromDate || toDate || statusFilter !== "all"
                                    ? "Try adjusting your filters"
                                    : "Confirmed and cancelled student requests will appear here"}
                            </p>
                        </div>
                    ) : (
                        <>
