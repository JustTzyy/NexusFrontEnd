...
import { Search, AlertCircle, CheckCircle2, X, BookOpen } from "lucide-react";
...
export default function ScheduleConfigurationIndex() {
    ...
    // Pick up navigation state alerts
    useEffect(() => {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            // Only show student-created requests that are still active (not terminal)
    ...
    const handlePrintPDF = () => {
        generatePDF({
            title: "Schedule Configuration Report",
            data: filtered,
            columns: [
    ...
    return (
        <AppLayout title="Schedule Configuration" onPrint={filtered.length > 0 ? handlePrintPDF : undefined}>
            {loading ? (
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Schedule Configuration</h1>
                            <p className="mt-1 text-sm text-gray-600">
                                Assign teachers and confirm schedules for student requests
                            </p>
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            {pendingCount > 0 && (
                                <Badge className="bg-blue-100 text-blue-700 px-3 py-1">
                                    {pendingCount} awaiting configuration
                                </Badge>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="border rounded-lg py-20 text-center bg-white">
                            ...
                            <p className="font-medium text-gray-600">
                                {q || fromDate || toDate || statusFilter !== "all"
                                    ...
                                    : "No requests need scheduling configuration"}
                            </p>
                            <p className="text-sm text-gray-400 mt-1">
                                {q || fromDate || toDate || statusFilter !== "all"
                                    ? "Try adjusting your filters"
                                    : "When students' requests receive teacher interest, they'll appear here"}
                            </p>
                        </div>
                    ) : (
                        <>
                                ...
                                {paged.map((request) => {
                                    ...
                                    return (
                                        <Card
                                            ...
                                            onClick={() => navigate(`/schedule-configuration/${request.id}`)}
                                        >
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <span className="block mt-1 text-red-600">
                                This will clear all assignments and notify the student.
                            </span>
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="py-4">
