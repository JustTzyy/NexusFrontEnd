...
export default function StudentRequestLog() {
    ...
    const handlePrintPDF = () => {
        generatePDF({
            title: "Student Request Log Report",
    ...
    const loadLogs = useCallback(async () => {
        ...
        try {
            ...
            // filter to student requests only
            ...
            console.error(err);
            setError(err.message || "Failed to load student request log");
            setLogs([]);
        } finally {
            setLoading(false);
        }
    ...
    return (
        <AppLayout title="Student Request Log" onPrint={logs.length > 0 ? handlePrintPDF : undefined}>
