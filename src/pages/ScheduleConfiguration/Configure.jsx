...
import {
    ...
    Calendar, FileText, Flag, MessageCircle, Users, XCircle,
...
export default function ScheduleConfigurationConfigure() {
    const { id } = useParams();
    ...
    const canSchedule = request?.status === "Waiting for Admin Approval" || request?.status === "Teacher Assigned";
    ...
    const handleSelectTeacher = (teacher) => {
        navigate(`/schedule-configuration/${id}/schedule`, {
            ...
            <div className="space-y-6">
                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="border rounded-xl bg-white p-6">
                                ...
                                <div className="flex items-center gap-0">
                                    {STATUS_ORDER.map((statusKey, idx) => {
                                        const isCompleted = currentStepValue > idx;
                                        const isCurrent = currentStepValue === idx;
                        ...
                        <div className="border rounded-xl bg-white overflow-hidden">
                            ...
                            <div className="p-6">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                                    ...
                                    <div className="space-y-1.5">
                                        <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
                                            <FileText className="h-4 w-4" /><span>Department</span>
                                        </div>
                                    ...
                                    <div className="space-y-1.5">
                                        <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
                                            <Flag className="h-4 w-4" /><span>Priority</span>
                                        </div>
                                    ...
                                    <div className="space-y-1.5">
                                        <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
                                            <Calendar className="h-4 w-4" /><span>Created</span>
                                        </div>
                                    ...
                                    {showTeacher && (
                                        <div className="space-y-1.5">
                                            <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
                                                <User className="h-4 w-4" /><span>Assigned Teacher</span>
                                            </div>
                                    ...
                                    {request.message && (
                                        <div className="space-y-1.5 md:col-span-3">
                                            <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
                                                <MessageCircle className="h-4 w-4" /><span>Student's Message</span>
                                            </div>
                        ...
                        {/* Schedule Details — visible when status >= "Waiting for Teacher Approval" */}
                        {showSchedule && (
                            <div className="border rounded-xl bg-white overflow-hidden">
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        ...
                                        <div className="space-y-1.5">
                                            <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
                                                <Calendar className="h-4 w-4" /><span>Day</span>
                                            </div>
