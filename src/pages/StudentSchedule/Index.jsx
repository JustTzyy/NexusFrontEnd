    ...
    const loadSchedule = useCallback(async () => {
        ...
        try {
            const [myRes, enrolledRes] = await Promise.all([
                tutoringRequestService.getMyRequests({ pageSize: 500 }),
                tutoringRequestService.getMyEnrolledSessions({ pageSize: 500 }),
            ]);
                                ...
                                >
                                    ...
                                    <div className={`w-32 flex-shrink-0 flex flex-col items-center justify-center gap-0.5 border-r px-3 py-3 ${
                                        ...
                                        <p className={`text-sm font-bold leading-tight ${
                                            isToday || hasItems ? "text-white" : "text-gray-400"
                                        }`}>
                                            {day}
                                        </p>
                                        {hasItems && (
                                                    ...
                                                    <Tooltip>
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-center gap-2 mt-1">
                                                                    {session.assignedTeacherName ? (
                                                                        ...
                                                                        <p className="text-[10px] text-gray-300 leading-none italic">No teacher yet</p>
                                                                    )}
                                                                    {session.roomName && (
                                                        ...
                                                        <TooltipContent side="top" className="max-w-[220px]">
                                                            <div className="space-y-1 text-xs">
                                                                ...
                                                                {session.assignedTeacherName && (
                                                                    <p className="flex items-center gap-1 text-gray-400">
                                                                        <User className="h-3 w-3" /> {session.assignedTeacherName}
                                                                    </p>
                                                                )}
                                                                {session.roomName && (
                                                                    <p className="flex items-center gap-1 text-gray-400">
